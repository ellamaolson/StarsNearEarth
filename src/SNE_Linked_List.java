...
// generic SNE_Linked_List class ------------------------------------
public class SNE_Linked_List<E> implements Cloneable, Iterable<E>, Collection<E>,
...
// definition of inner Node class ----------------------
   ...
   // constructors
   public SNE_Linked_List() { clear(); } 
   public SNE_Linked_List( Collection<? extends E> rhs )
   {
      clear();
      addAll(rhs);
   }
   ...
   // SNE_Linked_List public methods ------------------------------------
   ...
   // other SNE_Linked_List methods to satisfy java.util.collection
   ...
   {
      SNE_Linked_List<E> newObject = (SNE_Linked_List<E>)super.clone();
   ...
   {
      Node p1, p2;
      SNE_Linked_List<E> that;
      E thisData, thatData;
      
      if ( !(o instanceof SNE_Linked_List<?>) )
         return false;
      
      that = (SNE_Linked_List<E>)o;
      if (that.size() != mSize)
         return false;
