...
public class SNE_Array_List<E> implements Cloneable, Iterable<E>, Collection<E>
{
	   ...
	   // constructors
	   public SNE_Array_List() { clear(); }
	   public SNE_Array_List(int initCapacity) 
	   { 
	      clear(); 
	      ensureCapacity(initCapacity);
	   }
	 
	   public SNE_Array_List( Collection<? extends E> rhs )
	   {
	      clear();
	      addAll(rhs);
	   }
	   ...
	   // other SNE_Array_List methods to satisfy java.util.collection
	   ...
	   {
	      SNE_Array_List<E> newObject = (SNE_Array_List<E>)super.clone();
	   ...
	   {
	      int k;
	      SNE_Array_List<E> that;
	      E thisData, thatData;
	      
	      if ( !(o instanceof SNE_Array_List<?>) )
	         return false;
	      
	      that = (SNE_Array_List<E>)o;
	      if (that.size() != mSize)
	         return false;
	   ...
	   public java.util.Iterator<E> iterator() { return new SNE_Iterator(); }
	   public java.util.ListIterator<E> listIterator() 
	   { 
	      return new SNE_List_Iterator();
	   }
	   ...
	   public java.util.ListIterator<E> listIterator(int index) 
	   {
	      ...
	      return new SNE_List_Iterator(index); 
	   }

	   // internal Iterator class
	   private class SNE_Iterator implements java.util.Iterator<E>
	   {
	      // for use with derived SNE_List_Iterator methods remove(), set().
	      ...
	      public void remove()
	      {
	         ...
	         SNE_Array_List.this.remove(mLastIndexReturned);
	      ...
	      SNE_Iterator() { mCurrent = 0; }
	   }
	   
	   // internal ListIterator class
	   private class SNE_List_Iterator extends SNE_Iterator 
	      implements java.util.ListIterator<E>
	   {
	      
	      //  constructors (default access for package only)
	      SNE_List_Iterator() { super(); }
	      
	      SNE_List_Iterator(int index)
	      {
	         super();
	         if ( index < 0 || index >= mSize )
	            return;
	      ...
	      public void add(E x) 
	      {
	         if (mIterModCount != modCount)
	            throw new ConcurrentModificationException();
	         SNE_Array_List.this.add(mCurrent++, x);
	         mIterModCount++;
	         mLastIndexReturned = NOT_VALID;
	      }
	   }
